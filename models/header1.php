...
<header class="header_area">
    <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between header classy-nav">
        <!-- Classy Menu -->
        <nav class="classy-navbar" id="essenceNav">
            <!-- Logo -->
            <a class="nav-brand " href="index.php" id="logo"><img src="./img/harleylogo.png" alt=""  width="200px"></a>
            <!-- Navbar Toggler -->
        ...
        <div class="header-meta d-flex clearfix justify-content-end">
            ...
            <!-- Favourite Area -->
            <div id="user-info" style="background-color:#fff">
            <!-- User Login Info -->
                <?php
                    $output = include("../WEB2/XuLy/header.php");
                    echo $output->user;
            ...
            <!-- Cart Area -->
            <div class="cart-area" style="background-color:#fff">
